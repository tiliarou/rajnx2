...
namespace sts::cfg {
    ...
    bool IsHblOverrideKeyHeld(ncm::TitleId title_id) {
        ...
        /* Check HBL config. */
        return IsHblTitleId(title_id) ^ IsOverrideKeyHeld(ParseOverrideKey("R"));
    }
    ...
    void GetOverrideKeyHeldStatus(bool *out_hbl, bool *out_title, ncm::TitleId title_id) {
        ...
        /* Set HBL output. */
        *out_hbl = IsHblTitleId(title_id) ^ IsOverrideKeyHeld(ParseOverrideKey("R"));
    ...
    bool IsHblTitleId(ncm::TitleId title_id) {
        return title_id == ncm::TitleId::AppletPhotoViewer;
    }
